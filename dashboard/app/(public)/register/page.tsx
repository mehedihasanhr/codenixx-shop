...
export default function Login() {
  return (
    <div className="grid h-screen w-screen place-items-center">
      <div className="h-full w-full overflow-hidden rounded-lg border border-neutral-100 bg-white shadow-lg shadow-neutral-200 sm:h-[450px] sm:max-w-[400px] md:max-w-[900px] lg:h-[600px]">
        <div className="grid h-full grid-cols-12 md:gap-2.5">
          <div className="hidden md:col-span-6 md:block lg:col-span-6">
            <div className="relative m-auto h-fit max-h-[500px] w-full overflow-hidden md:max-h-[600px]">
              <Image
